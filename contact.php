...
<?php include './components/navbar.php'; ?>
    ...
    <div class="container content">
        <div class="row mb-2">
            <div class="col-lg-12">
                <h1 class="display-4 text-center contact-page-main-title">Neem Contact Met <span style="color:#056839">Ons</span></h1>
                <h4 class="text-center contact-page-main-subtitle">Laten we <span style="color:#056839">kennis maken</span></h4>
            </div>
        </div>
    </div>
