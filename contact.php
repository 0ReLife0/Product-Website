...
<?php include './components/navbar.php'; ?>
    ...
    <div class="container content">
        <div class="row mb-2">
            <div class="col-lg-12">
                <h1 class="display-4 text-center contact-page-main-title fadeInTop" >Neem Contact Met <span style="color:#056839">Ons</span></h1>
                <h4 class="text-center contact-page-main-subtitle fadeInTop">Laten we <span style="color:#056839">kennis maken</span></h4>
            </div>
        </div>
    </div>
    <div id="contact-container" class="container mt-5">
        <div class="row">
            <div class="col-lg-8 mx-auto form-container" id="form-container" >
    ...
    <!-- Map Container -->
    <div id="map-container" class="container-fluid fadeInBottom">
        <iframe
